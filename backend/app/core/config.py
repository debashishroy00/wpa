...
class Settings(BaseSettings):
    ...
    # CORS
    CORS_ORIGINS: str = "https://smartfinanceadvisor.net,https://www.smartfinanceadvisor.net,http://localhost:3004,http://localhost:3005,http://localhost:3011,http://127.0.0.1:3004,http://127.0.0.1:3005,http://127.0.0.1:3011"
