...
api_router.include_router(intelligence_stub.router, prefix="/intelligence", tags=["intelligence-stub"])  # Stub to prevent 404s
...
api_router.include_router(llm.router, prefix="/llm", tags=["step5-llm"])  # Re-enabled for frontend compatibility
...
api_router.include_router(tax_stub.router, prefix="/tax", tags=["tax-stub"])  # Stub to prevent 404s
