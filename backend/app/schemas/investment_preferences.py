...
class InvestmentPreferencesBase(BaseModel):
    ...
    alternative_investment_interest: Optional[float] = Field(0, ge=0, le=100, description="Interest level in alternative investments %")
    cryptocurrency_allocation: Optional[float] = Field(0, ge=0, le=100, description="Cryptocurrency allocation %")
    individual_stock_tolerance: Optional[float] = Field(0, ge=0, le=100, description="Tolerance level for individual stocks %")
